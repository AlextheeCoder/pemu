                            ...
                            <div class="card-body">
                                ...
                                <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                                    @if ($percentageChange > 0)
                                        <span><i
                                                class="fa fa-fw fa-arrow-up"></i></span><span>{{ round($percentageChange, 1) }}%</span>
                                    @elseif ($percentageChange == 0)
                                        <span>N/A</span>
                                    @else
                                        <span><i style="color: red" class="fa fa-fw fa-arrow-down"></i></span><span
                                            style="color: red;">{{ round($percentageChange, 1) }}%</span>
                                    @endif
                            ...
                            <div class="card-body">
                                ...
                                <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                                    ...
                                    @if ($percentageIncrease > 0)
                                        <span><i
                                                class="fa fa-fw fa-arrow-up"></i></span><span>{{ $percentageIncrease }}%</span>
                                    @elseif ($percentageIncrease == 0)
                                        <span>N/A</span>
                                    @else
                                        <span><i style="color: red" class="fa fa-fw fa-arrow-down"></i></span><span
                                            style="color: red;">{{ $percentageIncrease }}%</span>
                                    @endif
                            ...
                            <div class="card-body">
                                ...
                                <div class="metric-label d-inline-block float-right text-secondary font-weight-bold">
                                    @if ($BlogpercentageChange > 0)
                                        <span><i class="fa fa-fw fa-arrow-up" style="color: green"></i></span><span
                                            style="color: green">{{ $BlogpercentageChange }}%</span>
                                    @elseif ($BlogpercentageChange == 0)
                                        <span>N/A</span>
                                    @else
                                        <span><i style="color: red" class="fa fa-fw fa-arrow-down"></i></span><span
                                            style="color: red;">{{ $BlogpercentageChange }}%</span>
                                    @endif
                                </div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="m-r-10"><img
                                                                    src="{{ $blog->image ? asset('storage/' . $blog->image) : asset('Admin/assets/images/product-pic.jpg') }}"
                                                        ...
                                                        @if ($blog->status == 'published')
                                                            <td><span
                                                                    class="badge-dot badge-success mr-1"></span>{{ $blog->status }}
                                                            </td>
                                                        @else
                                                            <td><span
                                                                    class="badge-dot badge-brand mr-1"></span>{{ $blog->status }}
                                                            </td>
                                                        @endif
                                                        ...
                                                        <td>
                                                            ...
                                                            <form method="POST"
                                                                action="{{ route('blog.delete', ['blog' => $blog->id]) }}">
                                                                @csrf
                                                                @method('DELETE')
                                            ...
                                            @endunless
                                            <tr>
                                                <td colspan="9"><a href="/pemu/admin/view/blogs"
                                                        class="btn btn-outline-light float-right">View All</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                        ...
                                        <tbody>
                                            @unless (count($mostviewdblogs) == 0)
                                                @foreach ($mostviewdblogs as $mostviewdblog)
                                                    <tr>
                                                        <td class="truncate-title"><a
                                                                href="{{ route('blog.detail', ['slug' => $mostviewdblog->slug]) }}">{{ $mostviewdblog->title }}</a>
                                                        </td>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <a href="/pemu/admin/view/blogs"
                                                        class="btn btn-outline-light float-right">View All Blogs</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="card-body p-0">
                                <ul class="social-sales list-group list-group-flush">
                                    <li class="list-group-item social-sales-content"><span
                                            ...
                                            class="social-sales-count text-dark">..</span>
                                    </li>
                                    <li class="list-group-item social-sales-content"><span
                                    ...
                                    <li class="list-group-item social-sales-content"><span
                                            class="social-sales-icon-circle linkedin-bgcolor mr-2"><i
                                                class="fab fa-linkedin-in"></i></span><span
                                            class="social-sales-name">LinkedIn</span><span
                                            class="social-sales-count text-dark">..</span>
                                    </li>
                                ...
                                <ul class="country-sales list-group list-group-flush">
                                    @foreach ($topLocationsWithPercentage as $location)
                                        <li class="country-sales-content list-group-item">
                                            <span class="mr-2"><i
                                                    class="flag-icon flag-icon-{{ strtolower($location->country_code) }}"
                                                    title="{{ strtolower($location->country_code) }}"></i> </span>
