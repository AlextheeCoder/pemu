                       ...
                       <div class="row">
                           <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                               ...
                               <div class="card">
                                   ...
                                   <div class="card-body">
                                       <form class="blog-form" method="POST" action="{{ route('blog.update', ['blog' => $blog->id]) }}" enctype="multipart/form-data" onsubmit="return validateForm()">
                                           @csrf
                                           @method('PUT')
                                           <div class="form-group">
                                               <label for="inputText3" class="col-form-label">Blog Title</label>
                                               <input id="inputText3" type="text" class="form-control" name="title" required value="{{$blog->title}}">
                                               @error('title')
                                           ...
                                           <div class="form-group">
                                               ...
                                               <input id="inputText3" type="text" class="form-control" name="tags"  value="{{$blog->tags}}" placeholder="Example: Farming, Accounting, Marketing, etc">
                                           ...
                                           <div class="form-group">
                                               ...
                                               <div id="exampleFormControlTextarea1" style="height:500px;"> {!! $blog->content !!} </div> 
                                           ...
                                           <div class="form-group">
                                               ...
                                               <button type="submit" class="btn btn-success" onclick="setStatus('published')">Publish Edit</button>
                                               <button type="submit" class="btn btn-warning" style="margin-left: 30px" onclick="setStatus('staged')">Stage Blog</button>
                                           </div>
                                       </form>
                                   </div>
