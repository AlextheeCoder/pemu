    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="/pemu-admin" style="color: #056a3b">PEMU ADMIN</a>
                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown notification">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right notification-dropdown">
                                    ...
                                    <div class="notification-list">
                                        <div class="list-group">
                                            @php
                                                ...
                                                $notifications = Contact::orderBy('created_at', 'DESC')
                                                    ->limit(4)
                                                    ->get();
                                            @endphp
                                                    ...
                                                    <a href="#" class="list-group-item list-group-item-action active">
                                                        <div class="notification-info">
                                                            ...
                                                            <div class="notification-list-user-block"><span
                                                                    class="notification-list-user-name">{{ $notification->name }}</span>a{{ $notification->subject }}
                                ...
                                <li>
                                    <div class="list-footer"> <a href="/pemu/contacts/view">View all notifications</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="/pemu/users/view">Registerd Users <span
                                                    class="badge badge-secondary">New</span></a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="nav-link" href="/pemu/view/surveys">Survey Analytics <span
                                                    class="badge badge-secondary">New</span></a>
                                        </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-3" aria-controls="submenu-3"><i
                                        class="fas fa-fw fa-chart-pie"></i>Blogs</a>
